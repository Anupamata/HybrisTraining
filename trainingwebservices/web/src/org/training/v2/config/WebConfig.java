...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "trainingwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "trainingwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "trainingwebservices.oauth2.tokenUrl";

	private static final String DESC = "trainingwebservices.v2.description";
	private static final String TITLE = "trainingwebservices.v2.title";
	private static final String VERSION = "trainingwebservices.v2.version";
	private static final String LICENSE = "trainingwebservices.v2.license";
	private static final String LICENSE_URL = "trainingwebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "trainingwebservices.content.negotiation.legacy";
